...
//    sqlSegment = "select uid from user where identifier in ('nkj',reogn,'cxkvzn',zxcnv)";
    ...
    // deu segment
    sqlSegment = "select uid from deu where date = '2013-11-01' and event='pay.*';select uid from deu where event='pay.*' and date = '2013-11-01'";
//    sqlSegment = "select uid from deu where event='pay.*' and date >= '2013-10-01' and date <= '2013-10-02'";
